...
public class Protocol {
	...
	public static final byte PROTO_OPCODE_REGISTER_NAMED_PIPE = 0x70;
		...
		public String toString() {
			...
			switch( opcode ) {
				...
				case PROTO_OPCODE_REGISTER_NAMED_PIPE:
					ret += "PROTO_OPCODE_REGISTER_NAMED_PIPE";
					break;
	...
	public NamedPipeHeader namedPipeHeader = new NamedPipeHeader();
	...
	public Protocol( int keySize, int chunkSize ) {
		...
		this.namedPipeHeader.data = this.buf;
	...
	public int generateKeyValueHeader( byte magic, byte to, byte opcode, int instanceId, int id, int keySize, byte[] key, int valueSize ) {
	...
	public int generateKeyValueHeader( byte magic, byte to, byte opcode, int instanceId, int id, int keySize, byte[] key, int valueSize, byte[] value ) {
		int ret = this.generateKeyValueHeader( magic, to, opcode, instanceId, id, keySize, key, valueSize );
	...
	public int generateKeyValueUpdateHeader( byte magic, byte to, byte opcode, int instanceId, int id, int keySize, byte[] key, int valueUpdateOffset, int valueUpdateSize ) {
		int ret = this.generateHeader( magic, to, opcode, PROTO_KEY_VALUE_UPDATE_SIZE + keySize + valueUpdateSize, instanceId, id );
	...
	public int generateKeyValueUpdateHeader( byte magic, byte to, byte opcode, int instanceId, int id, int keySize, byte[] key, int valueUpdateOffset, int valueUpdateSize, byte[] valueUpdate ) {
		int ret = this.generateKeyValueUpdateHeader( magic, to, opcode, instanceId, id, keySize, key, valueUpdateOffset, valueUpdateSize );
