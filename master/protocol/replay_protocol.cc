...
char *MasterProtocol::replaySet( size_t &size, uint16_t instanceId, uint32_t requestId, char *key, uint8_t keySize, char *value, uint8_t valueSize ) {
...
char *MasterProtocol::replayUpdate( size_t &size, uint16_t instanceId, uint32_t requestId, char *key, uint8_t keySize, char *valueUpdate, uint8_t valueUpdateOffset, uint32_t valueUpdateSize) {
