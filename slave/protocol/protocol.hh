...
public:
	...
	// Heartbeat
	char *sendHeartbeat( size_t &size, uint32_t id, std::unordered_map<Key, OpMetadata> &opMetadataMap, std::unordered_map<Key, RemappingRecord> &remapRecord, LOCK_T *lock, LOCK_T *rlock, size_t &count, size_t &remapCount );
