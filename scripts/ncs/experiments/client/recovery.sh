...
time java -cp . edu.cuhk.cse.memec.Main 255 4096 $(hostname -I | sed 's/^.*\(192\.168\.0\.[0-9]*\).*$/\1/g') 9112 $size 30 4060 64
# time ./test 255 4096 4080 $size 32 false $(hostname -I | sed 's/^.*\(192\.168\.0\.[0-9]*\).*$/\1/g') 9112
